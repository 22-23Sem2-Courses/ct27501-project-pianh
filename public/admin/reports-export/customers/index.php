...
<head>
    ...
    <title>Xuất báo cáo khách hàng</title>
    <!-- Bootstrap CSS -->
                        ...
                        <div class="page-title-wrapper">
                            <div class="page-title-heading wow fadeIn" data-wow-duration="1s">
                                ...
                                <div>
                                    ...
                                    <div class="page-title-subheading wow fadeIn" data-wow-duration="2s">Xuất báo cáo danh sách các khách hàng của bạn.</div>
                                </div>
                            </div>
                    ...
                    <div class="tabs-animation">
                        <div class="card mb-3">
                            <div class="card-header">
                                ...
                                Table Xuất báo cáo khách hàng
                            </div>
                            <div class="card-body">
                                         
                                <table id="tblCustomersExport" class="table table-bordered table-hover table-responsive-lg table-striped table-sm ">
